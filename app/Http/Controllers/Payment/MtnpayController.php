...
class MtnpayController extends Controller
{
    public function pay(Request $request)
    {
        try {
            ...
            if (
                ...
                return redirect()->route('process.payment.mtn.index');
            } else {
                curl_close($ch);
    ...
    public function index(Request $request)
    {
        ...
        return view('frontend.payment.mtn', compact('amount', 'price', 'reference'));
    }
}
