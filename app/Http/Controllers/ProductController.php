...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        $products = $products->where('digital', 0)->orderBy('created_at', 'desc')->paginate(15, ['*'], 'page', $page);
        $productCheckingID = 0;

        return view('backend.product.products.index', compact('products', 'type', 'col_name', 'query', 'sort_search', 'productCheckingID'));
    }
    ...
    public function seller_products(Request $request, $product_type)
    {
        ...
        $products = $products->orderBy('created_at', 'desc')->paginate(15, ['*'], 'page', $page);
        $type = 'Seller';
        $productCheckingID = 0;
        ...
        return view('backend.product.products.index', compact('products', 'type', 'col_name', 'query', 'seller_id', 'sort_search', 'productCheckingID'));
    }
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'page'));
    }
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        $page = $request->input('page', 1);
        $productCheckingID = $product->id;

        return redirect()->route('products.all', [
            'page' => $page, 'productCheckingID' => $productCheckingID,
        ]);
    }
