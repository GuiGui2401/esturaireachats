...
use App\Http\Controllers\Payment\AfrikPayController;
use App\Http\Controllers\Payment\AuthorizenetController;
use App\Http\Controllers\Payment\BkashController;
use App\Http\Controllers\Payment\InstamojoController;
use App\Http\Controllers\Payment\IyzicoController;
use App\Http\Controllers\Payment\MasterpayController;
use App\Http\Controllers\Payment\MercadopagoController;
use App\Http\Controllers\Payment\MtnpayController;
use App\Http\Controllers\Payment\NagadController;
use App\Http\Controllers\Payment\NgeniusController;
use App\Http\Controllers\Payment\OrangepayController;
...
use App\Http\Controllers\Payment\VisapayController;
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/afrikPay', [AfrikPayController::class, 'show_payments'])->name('payment.form');


    Route::controller(MtnpayController::class)->group(function () {
        Route::post('/mtnPay/process_payment', 'pay')->name('mtn.process.payment');
        Route::get('/mtnPay/process_payment/index',  'index')->name('process.payment.mtn.index');
    });

    Route::controller(OrangepayController::class)->group(function () {
        Route::post('/orangePay/process_payment', 'pay')->name('orange.process.payment');
        Route::get('/orangePay/process_payment/index',  'index')->name('process.payment.orange.index');
    });

    Route::controller(VisapayController::class)->group(function () {
        Route::post('/visaPay/process_payment', 'pay')->name('visa.process.payment');
        Route::get('/visaPay/process_payment/index',  'index')->name('process.payment.visa.index');
    });

    Route::controller(MasterpayController::class)->group(function () {
        Route::post('/masterPay/process_payment', 'pay')->name('master.process.payment');
        Route::get('/masterPay/process_payment/index',  'index')->name('process.payment.master.index');
    });

    Route::get('/retrieve-request-details', [WebhookController::class, 'retrieveRequestDetails']);
});
