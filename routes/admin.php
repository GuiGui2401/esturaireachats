...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        //Translation Poducts
        Route::get('/product/translate/{lang?}', 'product_translate')->name('product_translate.index')->defaults('lang', 'en');
        Route::get('/product/translate_copie', 'product_translate_copier')->name('product_translate_copier.index');
        Route::post('/product/translate/update/{product}', 'translate_products_update')->name('product_translate.update');
    ...
    Route::controller(AfrikPayController::class)->group(function () {
        Route::post('/collect-payement', 'collect_payement')->name('collect_payement');
        Route::post('/payout', 'payout')->name('payout');
        Route::post('/check-status', 'check_status')->name('check_status');
    });
});
