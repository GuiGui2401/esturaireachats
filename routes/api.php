...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::post('/chatbot/upload-image', [ChatBotController::class, 'uploadImage']);
    Route::post('/image-search', [\App\Http\Controllers\SearchController::class, 'searchByImage'])->name('api.image.search');
    Route::get('/image-search-results', [\App\Http\Controllers\SearchController::class, 'getImageSearchResults'])->name('api.image.search.results');
    ...
    Route::any('razorpay/pay-with-razorpay', 'App\Http\Controllers\Api\V2\RazorpayController@payWithRazorpay')->name('api.razorpay.init');
