<form class="was-validated " action="{{ route('customer_package.make_offline_payment') }}" method="post"
            ...
            @foreach (\App\Models\ManualPaymentMethod::all() as $method)
                <div class="col-6 col-md-4">
                    <label class="aiz-megabox d-block mb-3">
                        <input value="{{ $method->heading }}" id="payment_option" type="radio" name="payment_option"
