...
@section('content')
    <div class="col-lg-10 mx-auto">
        <div class="card">
            ...
            <form class="was-validated form-horizontal" action="{{ route('seller_packages.store') }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="0" step="1"
                                placeholder="{{ translate('Product Upload Limit') }}" id="product_upload_limit"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="0" step="1"
                                placeholder="{{ translate('Validity in number of days') }}" id="duration" name="duration"
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
