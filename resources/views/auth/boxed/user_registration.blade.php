                ...
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    <div class="card shadow-none rounded-2 border-1">
                        <div class="row no-gutters">
                            <!-- Left Side Image-->
                            <div class="col-lg-6">
                                <img loading="lazy" src="{{ uploaded_asset(get_setting('customer_register_page_image')) }}"
                                    alt="{{ translate('Customer Register Page Image') }}" class="img-fit h-100 rounded-2">
                            </div>
                            ...
                            <div class="col-lg-6 p-4 p-lg-3 d-flex flex-column justify-content-center rounded-2 border right-content"
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form id="reg-form" class="form-default was-validated" role="form"
