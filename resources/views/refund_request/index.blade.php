                            ...
                            <td>
                                @if ($refund->orderDetail != null && $refund->orderDetail->product != null)
                                    <a href="{{ route('product', $refund->orderDetail->product->slug) }}" target="_blank"
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <img loading="lazy" src="{{ uploaded_asset($refund->orderDetail->product->thumbnail_img) }}"
...
@section('modal')
    <div class="modal fade reject_refund_request" id="modal-basic">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="was-validated form-horizontal member-block" action="{{ route('reject_refund_request') }}"
                    method="POST">
                    @csrf
    ...
    <div class="modal fade approve_refund_request" id="modal-basic">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="was-validated form-horizontal member-block"
                    action="{{ route('refund_request_money_by_admin') }}" method="POST">
                    @csrf
