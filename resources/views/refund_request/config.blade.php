    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <form class="was-validated form-horizontal" action="{{ route('refund_request_time_config') }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <label
                                class="col-lg-4 col-from-label">{{ translate('Set Time for sending Refund Request') }}</label>
                            <div class="col-lg-5">
                                <input type="number" min="0" step="1"
                                    value="{{ get_setting('refund_request_time') }}" placeholder="" name="value"
                                    class="form-control">
                            </div>
                            <div class="col-lg-3">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <form class="was-validated form-horizontal" action="{{ route('refund_sticker_config') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
