        ...
        <div class="card-header">
            <div class="row flex-grow-1">
                ...
                <div class="col-md-6 col-xl-4 ml-auto mr-0">
                    <form class="was-validated " id="sort_by_rating" action="{{ route('reviews.index') }}" method="GET">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input @can('publish_product_review') onchange="update_published(this)" @endcan
