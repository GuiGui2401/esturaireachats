    ...
    <div class="page-content">
        ...
        <div class="d-sm-flex">
            ...
            <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
                ...
                <form action="{{ route('products.store') }}" method="POST" class="was-validated"
                    enctype="multipart/form-data" enctype="multipart/form-data" id="choice_form">
                    @csrf
