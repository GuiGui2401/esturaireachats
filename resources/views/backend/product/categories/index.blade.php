...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-block d-md-flex">
            ...
            <form class="was-validated " id="sort_categories" action="" method="GET">
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                @if ($category->digital == 1)
                                    <img loading="lazy" src="{{ static_asset('assets/img/digital_tag.png') }}"
                            ...
                            <td>
                                @if ($category->banner != null)
                                    <img loading="lazy" src="{{ uploaded_asset($category->banner) }}" alt="{{ translate('Banner') }}"
                                        class="h-50px">
                                @else
                                    —
                                @endif
                            ...
                            <td>
                                @if ($category->icon != null)
                                    <span class="avatar avatar-square avatar-xs">
                                        <img loading="lazy" src="{{ uploaded_asset($category->icon) }}" alt="{{ translate('icon') }}">
                                    </span>
                                @else
                                    —
                                @endif
                            ...
                            <td>
                                @if ($category->icon != null)
                                    <img loading="lazy" src="{{ uploaded_asset($category->cover_image) }}"
