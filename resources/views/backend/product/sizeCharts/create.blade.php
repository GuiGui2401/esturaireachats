...
@section('content')
    ...
    <div class="">
        ...
        <form class="was-validated form form-horizontal mar-top" action="{{ route('size-charts.store') }}" method="POST"
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" onchange="size_combination()"
                                        ...
                                        @foreach ($measurementPoints as $measurementPoint)
                                            <option value="{{ $measurementPoint->id }}">{{ $measurementPoint->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <label class="aiz-checkbox mr-4">
                                        <input type="checkbox" name="measurement_option[]" value="inch"
                                            id="measurement_option_inch" onchange="size_combination()" checked>
                                        <span
