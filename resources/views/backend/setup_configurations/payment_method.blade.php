        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6 ">{{ translate('Afrikpay Credential') }}</h5>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal was-validated" action="{{ route('payment_method.update') }}"
                            method="POST">
                            <input type="hidden" name="payment_method" value="afrikpay">
                            @csrf
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_API_KEY">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client key') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_API_KEY"
                                        value="{{ env('AFRIKPAY_API_KEY') }}"
                                        placeholder="{{ translate('Afrikpay Client key') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_PROVIDER">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client Provider') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_PROVIDER"
                                        value="{{ env('AFRIKPAY_PROVIDER') }}"
                                        placeholder="{{ translate('Afrikpay Client Provider') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_REFERENCE">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client Reference') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_REFERENCE"
                                        value="{{ env('AFRIKPAY_REFERENCE') }}"
                                        placeholder="{{ translate('Afrikpay Client Reference') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_AMOUNT">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client Amount') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_AMOUNT"
                                        value="{{ env('AFRIKPAY_AMOUNT') }}"
                                        placeholder="{{ translate('Afrikpay Client Amount') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_STORE">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client store') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_STORE"
                                        value="{{ env('AFRIKPAY_STORE') }}"
                                        placeholder="{{ translate('Afrikpay Client store') }}" required>
                                </div>

                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_PURCHASEREF">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client purchaseref') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_PURCHASEREF"
                                        value="{{ env('AFRIKPAY_PURCHASEREF') }}"
                                        placeholder="{{ translate('Afrikpay Client purchaseref') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_SECRET">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client secret') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_SECRET"
                                        value="{{ env('AFRIKPAY_SECRET') }}"
                                        placeholder="{{ translate('Afrikpay Client secret') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_CODE">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client code') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_CODE"
                                        value="{{ env('AFRIKPAY_CODE') }}"
                                        placeholder="{{ translate('Afrikpay Client code') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_PASSWORD">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client password') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_PASSWORD"
                                        value="{{ env('AFRIKPAY_PASSWORD') }}"
                                        placeholder="{{ translate('Afrikpay Client password') }}" required>
                                </div>
                            </div>

                            <h2> {{ translate('Generate Key') }}</h2>
                            <hr>

                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_ACCOUNT_ID">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Client acount id') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_ACCOUNT_ID"
                                        value="{{ env('AFRIKPAY_ACCOUNT_ID') }}"
                                        placeholder="{{ translate('Afrikpay Client acount id') }}" required>
                                </div>
                            </div>

                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_GENERATE_TOKEN_USERNAME">
                                <div class="col-md-4">
                                    <label
                                        class="col-from-label">{{ translate('Afrikpay Client token generate username') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_GENERATE_TOKEN_USERNAME"
                                        value="{{ env('AFRIKPAY_GENERATE_TOKEN_USERNAME') }}"
                                        placeholder="{{ translate('Afrikpay Client token generate username') }}" required>
                                </div>
                            </div>

                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="AFRIKPAY_GENERATE_TOKEN_PASSWORD">
                                <div class="col-md-4">
                                    <label
                                        class="col-from-label">{{ translate('Afrikpay Client token generate password') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="AFRIKPAY_GENERATE_TOKEN_PASSWORD"
                                        value="{{ env('AFRIKPAY_GENERATE_TOKEN_PASSWORD') }}"
                                        placeholder="{{ translate('Afrikpay Client token generate password') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Afrikpay Sandbox Mode') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input value="1" name="afrikpay_sandbox" type="checkbox"
                                            @if (get_setting('afrikpay_sandbox') == 1) checked @endif>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="was-validated form-horizontal" action="{{ route('payment_method.update') }}"
                            method="POST">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        <input type="hidden" name="payment_method" value="paypal">
                        @csrf
                        <div class="form-group row">
