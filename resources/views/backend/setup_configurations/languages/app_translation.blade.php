...
@section('content')
    <div class="card">
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-4">
                <form class="was-validated " id="sort_keys" action="" method="GET">
        ...
        <form class="was-validated form-horizontal" action="{{ route('app-translations.store') }}" method="POST">
            @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control value" style="width:100%"
                                        ...
                                        @if (($traslate_lang = \App\Models\AppTranslation::where('lang', $language->app_lang_code)->where('lang_key', $translation->lang_key)->latest()->first()) != null) value="{{ $traslate_lang->lang_value }}" @endif>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
