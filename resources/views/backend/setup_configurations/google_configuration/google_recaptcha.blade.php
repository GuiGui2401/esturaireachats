    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('google_recaptcha.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="RECAPTCHA_SECRET_KEY"
                                    value="{{ env('RECAPTCHA_SECRET_KEY') }}" placeholder="{{ translate('SECRET KEY') }}"
                                    required>
                            </div>
                        </div>
