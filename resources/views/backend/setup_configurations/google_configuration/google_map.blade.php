    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('google-map.update') }}" method="POST">
                        @csrf
        ...
        @if (get_setting('google_map') == 1)
            <div class="col-md-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="was-validated form-horizontal" action="{{ route('business_settings.update') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10" id="">
                                    ...
                                    <input type="text" class="form-control mb-3" id="longitude"
                                        name="google_map_longtitude" value="{{ get_setting('google_map_longtitude') }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10" id="">
                                    ...
                                    <input type="text" class="form-control mb-3" id="latitude"
                                        name="google_map_latitude" value="{{ get_setting('google_map_latitude') }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group mb-0 text-right">
