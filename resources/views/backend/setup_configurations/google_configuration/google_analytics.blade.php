    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('facebook_pixel.update') }}" method="POST">
                        @csrf
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('google_analytics.update') }}"
                        method="POST">
                        @csrf
                        <div class="form-group row">
                            <div class="col-lg-3">
