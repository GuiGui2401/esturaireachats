                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('payment_method.update') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_ACCESS_KEY_ID"
                                    value="{{ env('BACKBLAZE_ACCESS_KEY_ID') }}"
                                    placeholder="{{ translate('BACKBLAZE_ACCESS_KEY_ID') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_SECRET_ACCESS_KEY"
                                    value="{{ env('BACKBLAZE_SECRET_ACCESS_KEY') }}"
                                    placeholder="{{ translate('AWS_SECRET_ACCESS_KEY') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_DEFAULT_REGION"
                                    value="{{ env('BACKBLAZE_DEFAULT_REGION') }}"
                                    placeholder="{{ translate('BACKBLAZE_DEFAULT_REGION') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_BUCKET"
                                    value="{{ env('BACKBLAZE_BUCKET') }}"
                                    placeholder="{{ translate('BACKBLAZE_BUCKET') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_ENDPOINT"
                                    value="{{ env('BACKBLAZE_ENDPOINT') }}"
                                    placeholder="{{ translate('BACKBLAZE_ENDPOINT') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_URL"
                                    value="{{ env('BACKBLAZE_URL') }}" placeholder="{{ translate('BACKBLAZE_URL') }}"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <label class="aiz-switch mb-0">
                        <input type="radio" name="FILESYSTEM_DRIVER"
                            onchange="updateSettings(this, 'FILESYSTEM_DRIVER', 'aws')" <?php if (env('FILESYSTEM_DRIVER') == 'aws') {
                                echo 'checked';
                            } ?>>
                        <span></span>
                    </label>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <label class="aiz-switch mb-0">
                        <input type="radio" name="FILESYSTEM_DRIVER"
                            onchange="updateSettings(this, 'FILESYSTEM_DRIVER', 'backblaze')" <?php if (env('FILESYSTEM_DRIVER') == 'backblaze') {
                                echo 'checked';
                            } ?>>
                        <span></span>
                    </label>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <label class="aiz-switch mb-0">
                        <input type="radio" name="FILESYSTEM_DRIVER"
                            onchange="updateSettings(this, 'FILESYSTEM_DRIVER', 'local')" <?php if (env('FILESYSTEM_DRIVER') == 'local') {
                                echo 'checked';
                            } ?>>
                        <span></span>
                    </label>
