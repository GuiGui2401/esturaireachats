			...
			<div class="row">
					...
					<label class="aiz-megabox d-block mb-3">
						...
						<span class="d-block aiz-megabox-elem rounded-0 img-overlay">
							<div class="h-190px w-100 overflow-hidden">
								<img loading="lazy" src="{{ static_asset('assets/img/authentication_pages/boxed.png') }}" class="w-100" alt="authentication-page">
							</div>
						</span>
					</label>
				...
				<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
					<label class="aiz-megabox d-block mb-3">
						...
						<span class="d-block aiz-megabox-elem rounded-0 img-overlay">
							<div class="h-190px w-100 overflow-hidden">
								<img loading="lazy" src="{{ static_asset('assets/img/authentication_pages/free.png') }}" class="w-100" alt="authentication-page">
							</div>
						</span>
					</label>
					<div class="d-flex flex-wrap justify-content-between align-items-center">
				...
				<div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
					<label class="aiz-megabox d-block mb-3">
						...
						<span class="d-block aiz-megabox-elem rounded-0 img-overlay">
							<div class="h-190px w-100 overflow-hidden">
								<img loading="lazy" src="{{ static_asset('assets/img/authentication_pages/focused.png') }}" class="w-100" alt="authentication-page">
							</div>
						</span>
					</label>
					<div class="d-flex flex-wrap justify-content-between align-items-center">
...
@section('modal')
	<div class="image-show-overlay" id="image-show-overlay">
		...
		<div class="overlay-img">
			<img loading="lazy" src="{{ static_asset('assets/img/authentication_pages/boxed.png') }}" class="w-100" alt="img-show">
		</div>
	</div>
@endsection
