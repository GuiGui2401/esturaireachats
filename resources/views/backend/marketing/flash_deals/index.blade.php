    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="pull-right clearfix">
                <form class="was-validated " id="sort_flash_deals" action="" method="GET">
                ...
                <tbody>
                    @foreach ($flash_deals as $key => $flash_deal)
                        <tr>
                            ...
                            <td><img loading="lazy" src="{{ uploaded_asset($flash_deal->banner) }}" alt="banner" class="h-50px"></td>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input @can('publish_flash_deal') onchange="update_flash_deal_feature(this)" @endcan
                                        value="{{ $flash_deal->id }}" type="checkbox" <?php if ($flash_deal->featured == 1) {
                                            echo 'checked';
                                        } ?>
