                ...
                @canany(['general_settings', 'features_activation', 'language_setup', 'currency_setup',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('language_setup')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('product_translate.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['product_translate.index', 'product_translate.create', 'product_translate.store', 'product_translate.show', 'product_translate.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Translate Products') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('currency_setup')
