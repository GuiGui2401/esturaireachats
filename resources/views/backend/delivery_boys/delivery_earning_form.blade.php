...
<form class="was-validated form-horizontal" action="{{ route('paid-to-delivery-boy') }}" method="POST"
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" value="{{ $delivery_boy_info->total_earning }}"
                    readonly="">
            </div>
        </div>
