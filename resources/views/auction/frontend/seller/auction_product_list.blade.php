            ...
            <div class="col-md-4">
                <a href="{{ route('seller.seller_packages_list') }}"
                    ...
                    @if ($seller_package != null)
                        <img loading="lazy" src="{{ uploaded_asset($seller_package->logo) }}" height="44" class="mw-100 mx-auto">
                                ...
                                <td class="text-right">
                                    @if ($product->auction_start_date > strtotime('now'))
                                        <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                                            href="{{ route('auction_product_edit.seller', ['id' => $product->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                    ...
                                    <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                                        href="{{ route('product_bids.seller', $product->id) }}" target="_blank"
                                        title="{{ translate('View All Bids') }}">
                                        <i class="las la-gavel"></i>
                                    </a>
                                    <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                        data-href="{{ route('auction_product_destroy.seller', $product->id) }}"
