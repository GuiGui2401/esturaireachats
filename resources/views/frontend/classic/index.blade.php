                            ...
                            @foreach ($sliders as $key => $slider)
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <!-- Image -->
                                        <img class="d-block mw-100 img-fluid overflow-hidden h-180px h-md-320px h-lg-460px overflow-hidden"
                                            ...
                                            @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ $product_url }}"
                                                        ...
                                                        <!-- Image -->
                                                        <img loading="lazy" src="{{ get_image($flash_deal_product->product->thumbnail) }}"
                        ...
                        @foreach ($featured_categories->take(6) as $key => $category)
                            ...
                            <div class="col-xl-4 col-md-6 border-left border-bottom py-3 py-md-2rem">
                                <div class="d-sm-flex text-center text-sm-left">
                                    <div class="mb-3">
                                        <img loading="lazy" src="{{ isset($category->bannerImage->file_name) ? my_asset($category->bannerImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                        ...
                        @foreach ($brands as $brand)
                            <div
                                ...
                                <a href="{{ route('products.brand', $brand->slug) }}" class="d-block p-sm-3">
                                    <img loading="lazy" src="{{ isset($brand->brandLogo->file_name) ? my_asset($brand->brandLogo->file_name) : static_asset('assets/img/placeholder.jpg') }}"
