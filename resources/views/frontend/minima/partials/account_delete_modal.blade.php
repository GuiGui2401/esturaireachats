        ...
        <div class="modal-content">
                ...
                <div class="d-flex justify-content-center">
                    <span class="avatar avatar-md mb-2 mt-2">
                        @if (Auth::check() && Auth::user()->avatar_original != null)
                            <img loading="lazy" src="{{ uploaded_asset(Auth::user()->avatar_original) }}" class="m-auto"
                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" alt="{{ translate('avatar') }}">
                        @else
                            <img loading="lazy" src="{{ static_asset('assets/img/avatar-place.png') }}" class="image rounded-circle m-auto"
                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';" alt="{{ translate('avatar') }}">
                        @endif
                    </span>
                </div>
            ...
            <div class="modal-body pt-3 pb-5 px-xl-5">
                ...
                <div class="row bg-soft-warning py-2 mb-2 ml-0 mr-0 border-left border-width-2 border-danger">
                    <div class="col-1">
                        <img loading="lazy" src="{{ static_asset('assets/img/warning.png') }}" class="h-20px" alt="{{ translate('warning') }}">
                    </div>
                    <div class="col">
