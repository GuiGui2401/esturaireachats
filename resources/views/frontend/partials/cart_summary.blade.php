<div class="card rounded-0 border shadow-none">
    ...
    <div class="card-body">
        ...
        @if (addon_is_activated('club_point'))
            @if (Session::has('club_point'))
                <div class="mt-3">
                    <form class="was-validated " action="{{ route('checkout.remove_club_point') }}" method="POST"
        ...
        @if (Auth::check() && get_setting('coupon_system') == 1)
            @if ($coupon_discount > 0 && $coupon_code)
                <div class="mt-3">
                    <form class="was-validated " id="remove-coupon-form" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group">
            ...
            @else
                <div class="mt-3">
                    <form class="was-validated " id="apply-coupon-form" enctype="multipart/form-data">
                        @csrf
