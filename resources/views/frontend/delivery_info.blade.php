            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-10 mx-auto">
                    <div class="border bg-white p-4 mb-4">
                        <form class="was-validated form-default" action="{{ route('checkout.store_delivery_info') }}"
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center">
                                                        <span class="mr-2 mr-md-3">
                                                            <img loading="lazy" src="{{ get_image($product->thumbnail) }}"
                                                            ...
                                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                                ...
                                                                <span class="d-flex p-3 aiz-megabox-elem rounded-0">
                                                                    ...
                                                                    <span class="flex-grow-1 pl-3 fw-600">
                                                                        <img loading="lazy" src="{{ uploaded_asset($carrier->logo) }}"
