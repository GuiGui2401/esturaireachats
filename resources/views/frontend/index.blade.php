                                            ...
                                            @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ $product_url }}"
                                                        ...
                                                        <!-- Image -->
                                                        <img loading="lazy" src="{{ $flash_deal_product->product->thumbnail != null ? my_asset($flash_deal_product->product->thumbnail->file_name) : static_asset('assets/img/placeholder.jpg') }}"
