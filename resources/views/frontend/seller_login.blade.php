...
@section('content')
    <div class="h-100 bg-cover bg-center py-5 d-flex align-items-center"
        style="background-image: url({{ uploaded_asset(get_setting('seller_login_page_bg')) }})">
        <div class="container">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="mb-5 text-center">
                                @if (get_setting('system_logo_black') != null)
                                    <img loading="lazy" src="{{ uploaded_asset(get_setting('system_logo_black')) }}" class="mw-100 mb-4"
                                        height="40">
                                @else
                                    <img loading="lazy" src="{{ static_asset('assets/img/logo.png') }}" class="mw-100 mb-4" height="40">
                                @endif
                            ...
                            <form class="was-validated pad-hor" method="POST" role="form" action="{{ route('login') }}">
                                @csrf
                                <!-- Email or Phone -->
