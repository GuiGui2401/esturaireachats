...
@section('panel_content')
    ...
    <!-- Create a Ticket -->
    <div class="p-4 mb-3 c-pointer text-center bg-light has-transition border h-100 hov-bg-soft-light" data-toggle="modal"
                            ...
                            <td>
                                ...
                                @elseif ($ticket->status == 'open')
                                    <span class="badge badge-inline badge-secondary p-3 fs-12"
                                        style="border-radius: 25px; min-width: 80px !important;">{{ translate('Open') }}</span>
                                @else
                                    <span class="badge badge-inline badge-success p-3 fs-12"
                                        style="border-radius: 25px; min-width: 80px !important;">{{ translate('Solved') }}</span>
                                @endif
                            </td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body px-3 pt-3">
                    <form class="was-validated " action="{{ route('support_ticket.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3 rounded-0"
                                    placeholder="{{ translate('Subject') }}" name="subject" required>
                            </div>
                        </div>
                        ...
                        <div class="text-right mt-4">
                            ...
                            <button type="submit"
                                class="btn btn-primary rounded-0 w-150px">{{ translate('Send Ticket') }}</button>
                        </div>
                    </form>
                </div>
            </div>
