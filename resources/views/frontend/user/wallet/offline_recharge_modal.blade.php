<form class="was-validated " action="{{ route('wallet_recharge.make_payment') }}" method="post"
    ...
    <div class="modal-body gry-bg px-3 pt-3 mx-auto c-scrollbar-light">
        ...
        <div id="manual_payment_data">
            ...
            <div class="form-group text-right">
                <button type="submit"
                    class="btn btn-sm btn-primary rounded-0 w-150px transition-3d-hover">{{ translate('Confirm') }}</button>
            </div>
        </div>
    </div>
</form>
