...
@section('panel_content')
    ...
    <form class="was-validated " action="{{ route('customer_products.store') }}" method="POST" enctype="multipart/form-data"
        id="choice_form">
        @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" lang="en" min="0" step="0.01"
                            class="form-control rounded-0" name="unit_price"
        ...
        <div class="card rounded-0 shadow-none border">
            <div class="card-header border-bottom-0">
                <h5 class="mb-0 fs-18 fw-700 text-dark">{{ translate('Description') }} <span class="text-danger">*</span>
                </h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
        ...
        <div class="mar-all text-right">
            <button type="submit" name="button"
                class="btn btn-primary rounded-0 px-4">{{ translate('Save Product') }}</button>
        </div>
    </form>
@endsection
