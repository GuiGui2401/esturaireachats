...
@section('panel_content')
        ...
        @foreach (get_all_active_language() as $key => $language)
            <li class="nav-item">
                <a class="nav-link text-reset rounded-0 @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                    ...
                    <img loading="lazy" src="{{ static_asset('assets/img/flags/' . $language->code . '.png') }}" height="11" class="mr-1">
    ...
    <form class="was-validated " action="{{ route('customer_products.update', $product->id) }}" method="POST"
