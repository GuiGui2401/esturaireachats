                                    ...
                                    <div class="payment">
                                        <form id="payment-card-info" method="post" action="{{ route('dopay.online') }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <!--    <img loading="lazy" src="{{ asset('images/visa.jpg') }}" id="visa">-->
                                                <!--    <img loading="lazy" src="{{ asset('images/mastercard.jpg') }}" id="mastercard">-->
                                                <!--    <img loading="lazy" src="{{ asset('images/amex.jpg') }}" id="amex">-->
                                                <!--</div>-->
                                            </div>
