...
@section('content')
                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/paypal.png') }}"
                                                        class="img-fit mb-2">
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="stripe" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/stripe.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="mercadopago" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/mercadopago.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="sslcommerz" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/sslcommerz.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="instamojo" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/instamojo.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="razorpay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/rozarpay.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="paystack" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/paystack.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="voguepay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/vogue.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="payhere" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/payhere.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="ngenius" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/ngenius.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="iyzico" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/iyzico.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="nagad" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/nagad.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="bkash" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/bkash.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="aamarpay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/aamarpay.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="authorizenet" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/authorizenet.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="payku" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/payku.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                    ...
                                    @endif
                                    @if (get_setting('afrikpay_payment') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="afrikpay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/afrik.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('AfrikPay') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    @endif
                                    @if (get_setting('orangepay_payment') == 1)
                                        <a class="col-6 col-xl-3 col-md-4" href="javascript:void(0)"
                                            onclick="showAddToCartModal('{{ static_asset('assets/img/cards/orange.png') }}', '{{ route('orange.process.payment') }}', 'orangepay')">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="orangepay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/orange.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Orange Money') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </a>
                                    @endif
                                    @if (get_setting('mtnpay_payment') == 1)
                                        <a class="col-6 col-xl-3 col-md-4" href="javascript:void(0)"
                                            onclick="showAddToCartModal('{{ static_asset('assets/img/cards/mtn.png') }}', '{{ route('mtn.process.payment') }}', 'mtnpay')">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="mtnpay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/mtn.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('MTN Momo') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </a>
                                    @endif
                                    @if (get_setting('visapay_payment') == 1)
                                        <a class="col-6 col-xl-3 col-md-4" href="javascript:void(0)"
                                            onclick="showAddToCartModalPaymentCart('{{ static_asset('assets/img/cards/visa.png') }}', '{{ route('visa.process.payment') }}', 'visapay')">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="visapay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-4">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/visa.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Carte Visa') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </a>
                                    @endif
                                    @if (get_setting('masterpay_payment') == 1)
                                        <a class="col-6 col-xl-3 col-md-4" href="javascript:void(0)"
                                            onclick="showAddToCartModalPaymentCart('{{ static_asset('assets/img/cards/master.png') }}', '{{ route('master.process.payment') }}', 'masterpay')">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="masterpay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/master.png') }}"
                                                        class="img-fit mb-1">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('Carte Master') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </a>
                                    @endif
                                    @if (get_setting('eupay_payment') == 1)
                                        <a class="col-6 col-xl-3 col-md-4" href="javascript:void(0)"
                                            onclick="showAddToCartModal('{{ static_asset('assets/img/cards/eu.png') }}')">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="eupay" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img loading="lazy" src="{{ static_asset('assets/img/cards/eu.png') }}"
                                                        class="img-fit mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('EU Mobilemoney') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </a>
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="flutterwave" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/flutterwave.png') }}"
                                                            class="img-fit mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="payfast" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/payfast.png') }}"
                                                            class="img-fit mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="paytm" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/paytm.jpg') }}"
                                                            class="img-fit mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="toyyibpay" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/toyyibpay.png') }}"
                                                            class="img-fit mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="myfatoorah" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/myfatoorah.png') }}"
                                                            class="img-fit mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/khalti.png') }}"
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="phonepe" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/phonepe.png') }}"
                                                            class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="cash_on_delivery" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                        <img loading="lazy" src="{{ static_asset('assets/img/cards/cod.png') }}"
                                                            class="img-fit mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                            ...
                                            @foreach (get_all_manual_payment_methods() as $method)
                                                <div class="col-6 col-xl-3 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        ...
                                                        <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                            <img loading="lazy" src="{{ uploaded_asset($method->photo) }}"
                                                                class="img-fit mb-2">
                                                            <span class="d-block text-center">
                                                                <span
            ...
            <div class="modal-content position-relative">
                ...
                <div id="">
                    <div class="aiz-editor-data">
                        <img id="modalImage" src="" class="img-fit mb-2">
                    </div>
                    <div class="pb-5 pt-4 px-3 px-md-5">
                        <h3>{{ translate('Make your payment securely! Fill in the form') }}</h3>
                        <form action="" class="form-default was-validated" role="form" method="POST"
                            id="checkout-form-modale">
                            @csrf
                            <input value="" class="online_payment" type="radio" id="payment_option"
                                name="payment_option" checked>
                            <div class="form-group mb-2">
                                <input type="number" class="form-control required-field" placeholder="Your phone number"
                                    name="reference" required>
                            </div>
                            <div class="form-group mb-2">
                                <input type="hidden" class="form-control" value="{{ $total }}" name="amount"
                                    readonly>
                                <input type="text" class="form-control" value="{{ single_price($total) }}"
                                    name="price" readonly>
                            </div>
                            <div class="pt-3 px-4 fs-14">
                                <label class="aiz-checkbox">
                                    <input type="checkbox" required id="agree_checkbox_modal"
                                        onclick="syncCheckbox('modalpay')">
                                    <span class="aiz-square-check"></span>
                                    <span>{{ translate('I agree to the') }}</span>
                                </label>
                                <a href="{{ route('terms') }}"
                            ...
                            <button type="button" onclick="submitOrder(this, 'modale')"
                                class="btn btn-primary fs-14 fw-700 rounded-0 px-4">{{ translate('Complete Order') }}</button>
                        </form>
                    </div>
    ...
    <div class="modal fade" id="ModalCartPay">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size-cart"
            role="document">
            <div class="modal-content position-relative">
                <div class="c-preloader text-center p-3">
                    <i class="las la-spinner la-spin la-3x"></i>
                ...
                <div id="">
                    <div class="aiz-editor-data">
                        <img id="modalImageCart" src="" class="img-fit mb-2">
                    </div>
                    <div class="pb-5 pt-4 px-3 px-md-5">
                        <h3>{{ translate('Make your payment securely! Fill in the form') }}</h3>
                        <form action="" class="form-default was-validated" role="form" method="POST"
                            id="checkout-form-modale-cart">
                            @csrf
                            <input value="" class="online_payment" type="radio" id="payment_option_cart"
                                name="payment_option" checked>
                            <div class="form-group mb-2">
                                <input type="email" class="form-control required-field-cart" placeholder="Your email"
                                    name="reference" required>
                            </div>
                            <div class="form-group mb-2">
                                <input type="hidden" class="form-control" value="{{ $total }}" name="amount"
                            ...
                            <div class="pt-3 px-4 fs-14">
                                <label class="aiz-checkbox">
                                    <input type="checkbox" required id="agree_checkbox_modal_cart"
                                        onclick="syncCheckbox('modalpayCart')">
                                    <span class="aiz-square-check"></span>
                                    <span>{{ translate('I agree to the') }}</span>
                                </label>
                                <a href="{{ route('terms') }}"
                            ...
                            <button type="button" onclick="submitOrder(this, 'modaleCart')"
                                class="btn btn-primary fs-14 fw-700 rounded-0 px-4">{{ translate('Complete Order') }}</button>
                        </form>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function submitOrder(el, origin) {
            $(el).prop('disabled', true);
            if (origin === "modale") {
                if ($('.required-field:invalid').length === 0) {
                    if ($('#agree_checkbox').is(":checked")) {
                        if (minimum_order_amount_check && $('#sub_total').val() < minimum_order_amount) {
                            AIZ.plugins.notify('danger',
                                '{{ translate('You order amount is less then the minimum order amount') }}');
                    ...
                    AIZ.plugins.notify('danger', '{{ translate('Please fill all the required fields') }}');
                    $(el).prop('disabled', false);
                }
            } else if (origin === "modaleCart") {
                if ($('.required-field-cart:invalid').length === 0) {
                    if ($('#agree_checkbox').is(":checked")) {
                        if (minimum_order_amount_check && $('#sub_total').val() < minimum_order_amount) {
                            AIZ.plugins.notify('danger',
                                '{{ translate('You order amount is less then the minimum order amount') }}');
                            ...
                            if (offline_payment_active == '1' && $('.offline_payment_option').is(":checked") && $(
                                ...
                                $('#checkout-form-modale-cart').submit();
                            }
                        }
                    } else {
                        AIZ.plugins.notify('danger', '{{ translate('You need to agree with our policies') }}');
        ...
        function showAddToCartModal(imageUrl, formAction, paymentOption) {
            if (!$('#modal-size').hasClass('modal-lg')) {
                $('#modal-size').addClass('modal-lg');
            }
            document.getElementById('modalImage').src = imageUrl;
            document.getElementById('payment_option').value = paymentOption;
            document.getElementById('checkout-form-modale').action = formAction;
            $('#ModalPay').modal();
            $('.c-preloader').show();
            $('.c-preloader').hide();
        }

        function showAddToCartModalPaymentCart(imageUrl, formAction, paymentOption) {
            if (!$('#modal-size-cart').hasClass('modal-lg')) {
                $('#modal-size-cart').addClass('modal-lg');
            }
            document.getElementById('modalImageCart').src = imageUrl;
            document.getElementById('payment_option_cart').value = paymentOption;
            document.getElementById('checkout-form-modale-cart').action = formAction;
            $('#ModalCartPay').modal();
            $('.c-preloader').show();
            $('.c-preloader').hide();
        }

        function syncCheckbox(origin) {
            if (origin == "modalpay") {
                var modalCheckbox = document.getElementById('agree_checkbox_modal');
            } else if (origin == "modalpayCart") {
                var modalCheckbox = document.getElementById('agree_checkbox_modal_cart');
            }
            var pageCheckbox = document.getElementById('agree_checkbox');
