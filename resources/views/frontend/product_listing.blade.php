                                ...
                                <div class="col-lg col-10">
                                    <h1 class="fs-20 fs-md-24 fw-700 text-dark">
                                        ...
                                        @elseif(isset($query))
                                            ...
                                            @if(request()->has('image_search') && request()->image_search == 1)
                                            <div class="alert alert-info mt-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <strong>{{ translate('Image Search Results') }}</strong><br>
                                                        <span>{{ translate('Showing products similar to your image') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
