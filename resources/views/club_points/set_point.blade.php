        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="was-validated form-horizontal" action="{{ route('set_products_point.store') }}"
                        method="POST">
                        @csrf
                        <div class="form-group row">
                            <div class="col-lg-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('set_all_products_point.store') }}"
                        method="POST">
                        @csrf
                        <div class="form-group row">
                            <div class="col-lg-4">
