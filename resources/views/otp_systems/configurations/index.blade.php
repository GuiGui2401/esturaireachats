    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('update_credentials') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('update_credentials') }}"
                        method="POST">
