                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if (Auth::user()->shop->seller_package)
                            <div class="d-flex">
                                <div class="col-3">
                                    <img loading="lazy" src="{{ uploaded_asset(Auth::user()->shop->seller_package->logo) }}"
            ...
            <div
                ...
                @if (Auth::user()->shop->verification_status == 0)
                    <div class="my-n4 py-1 text-center">
                        <img loading="lazy" src="{{ static_asset('assets/img/non_verified.png') }}" alt=""
                ...
                @else
                    <div class="my-2 py-1">
                        <img loading="lazy" src="{{ static_asset('assets/img/verified.png') }}" alt="" width="">
                    </div>
                @endif
            </div>
        </div>
