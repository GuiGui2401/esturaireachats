    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('affiliate.store') }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                @php
                                    if (
                                        \App\Models\AffiliateOption::where(
                                            'type',
                                            'user_registration_first_purchase',
                                        )->first() != null
                                    ) {
                                        $percentage = \App\Models\AffiliateOption::where(
                                            'type',
                                            'user_registration_first_purchase',
                                        )->first()->percentage;
                                        $status = \App\Models\AffiliateOption::where(
                                            'type',
                                            'user_registration_first_purchase',
                                        )->first()->status;
                                    } else {
                    ...
                    <form action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                @php
                                    if (
                                        \App\Models\AffiliateOption::where('type', 'product_sharing')->first() !=
                                            null &&
                                        \App\Models\AffiliateOption::where('type', 'product_sharing')->first()
                                            ->details != null
                                    ) {
                                        $commission_product_sharing = json_decode(
                                            \App\Models\AffiliateOption::where('type', 'product_sharing')->first()
                                                ->details,
                                        )->commission;
                                        $commission_type_product_sharing = json_decode(
                                            \App\Models\AffiliateOption::where('type', 'product_sharing')->first()
                                                ->details,
                                        )->commission_type;
                                        $status = \App\Models\AffiliateOption::where('type', 'product_sharing')->first()
                                            ->status;
                                    } else {
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        @php
                            if (
                                \App\Models\AffiliateOption::where('type', 'category_wise_affiliate')->first() != null
                            ) {
                                $category_wise_affiliate_status = \App\Models\AffiliateOption::where(
                                    'type',
        ...
        <div class="col-md-6">
            <div class="card bg-gray-light">
                ...
                <div class="card-body">
                    <form class="was-validated form-horizontal" action="{{ route('affiliate.configs.store') }}"
                        method="POST">
                        @csrf
                        @php
                            $validation_time_info = \App\Models\AffiliateConfig::where(
                                'type',
                                'validation_time',
                            )->first();
                            $validation_time = '';
