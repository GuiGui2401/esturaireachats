        ...
        <div class="container">
            <div class="d-flex align-items-start">
                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="card">
                        <form class="was-validated " id="sort_blogs" action="" method="GET">
                            ...
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    @foreach ($affiliate_logs as $key => $affiliate_log)
                                        <tr>
                                            <td>{{ $key + 1 + ($affiliate_logs->currentPage() - 1) * $affiliate_logs->perPage() }}
                                            </td>
                                            <td>
    ...
    <div class="modal fade" id="affiliate_withdraw_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="was-validated " action="{{ route('affiliate.withdraw_request.store') }}" method="post">
                    @csrf
